...
<body>
    ...
    <hr>
    <h3 class="main">You are connected to the Project 3 Enterprise System database as a <span class="red">client-level</span> user.<br>
        Please enter any SQL query or update command in the box below.</h3>
    <form action="ExecuteClientSQLServlet" method="post">
